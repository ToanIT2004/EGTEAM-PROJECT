     ...
     <section className='relative w-full py-20 overflow-hidden'>
      <div className='container mx-auto px-4'>
        <div className='text-center mb-12'>
          <h2 className='text-[28px] md:text-[32px] lg:text-[36px] font-bold text-center text-[#00D768]'>
            VIDEO GIỚI THIỆU
          </h2>
        ...
        //   pagination={true}
          ...
          className='max-w-[1285px] aspect-video mx-auto rounded-3xl border-2 border-[#00E0FF] overflow-hidden group hover:shadow-[0_0_25px_rgba(0,224,255,0.4)] transition-all duration-500'
        >
